...
- `analysis/`: Contains detailed analysis for each module (MakerDAO, etc.).
  - `makerdao/`:
    - `governance/`: Voter turnout and poll analysis.
    - `collateral/`: Collateral composition and risk.
    - `operational/`: Liquidator and custodian decentralization.
- `logs/`: System and script execution logs.
- `resources/`: Raw research materials (PDFs, HackMD notes, Docs).
- `pipeline/`: Research pipeline scripts and tools.
- `progress_log.md`: Daily journal of research activities.
