...
try:
    ...
    # Attacker setup
    attacker_wallet = {stablecoin: 200000.0, collateral: 0.0}
    attacker = Attacker(attacker_wallet)
    attack_iteration = 1000
    attack_swap_amount = 100000.0
    ...
    print(f"Attacker Profit/Loss: {results['attacker_pnl']:.2f} USD")
    ...
    plt.ylabel("Price")
    plt.axvline(x=attack_iteration, color='r', linestyle='--', label='Attack')
    plt.legend()
