...
* **DAI**: **Over-collateralized**. Users lock >$1 value of crypto/RWA to mint $1 DAI. Safe but capital inefficient.
...
* **DAI**: Revenue from Stability Fees (interest). Sustainable model pivoting to Real World Assets (RWA).
...
* **DAI**: **Medium-High**. Governance is decentralized, but RWA/USDC collateral introduces centralized dependencies.
